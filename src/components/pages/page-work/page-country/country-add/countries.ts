export const allCountries = [
  ...
  { name: "Cote D'Ivoire (Ivory Coast)", isoCode: "CI" },
  ...
  { name: "Guernsey and Alderney", isoCode: "GG" },
  ...
  { name: "Hong Kong S.A.R.", isoCode: "HK" },
  ...
  { name: "Pitcairn Island", isoCode: "PN" },
  ...
  { name: "Svalbard And Jan Mayen Islands", isoCode: "SJ" },
  ...
  { name: "Vatican City State (Holy See)", isoCode: "VA" },
  { name: "Venezuela", isoCode: "VE" },
  { name: "Vietnam", isoCode: "VN" },
  { name: "Virgin Islands (British)", isoCode: "VG" },
  { name: "Virgin Islands (US)", isoCode: "VI" },
  { name: "Wallis And Futuna Islands", isoCode: "WF" },
